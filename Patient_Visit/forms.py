...
class Patiant_File_NO_Form(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['patiant_no_form' ,'social_number', 'ar_patiant_name' ,'en_patiant_name' ,'birth_date' , 'gender', 'country', 'mobile_no']
        widgets = {'birth_date': forms.DateInput(format=('%Y-%m-%d'), attrs={'class': 'form-control', 'placeholder': 'Select a date', 'type': 'date'}),}
